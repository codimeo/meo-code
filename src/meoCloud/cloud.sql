...
GRANT SELECT ON TABLE public.projects TO cloud;
...
GRANT SELECT ON TABLE public.active_projects TO cloud;
...
GRANT SELECT ON TABLE public.users TO cloud;
...
GRANT UPDATE(email) ON TABLE public.users TO cloud;
...
GRANT SELECT ON TABLE public.active_users TO cloud;
...
GRANT SELECT ON TABLE public.count_recent_projects TO cloud;
...
GRANT SELECT ON TABLE public.deleted_projects TO cloud;
...
GRANT SELECT ON TABLE public.deleted_users TO cloud;
...
GRANT SELECT ON TABLE public.recent_projects_2_days TO cloud;
...
GRANT SELECT ON TABLE public.remixes TO cloud;
...
GRANT SELECT ON TABLE public.tokens TO cloud;
...
ALTER DEFAULT PRIVILEGES FOR ROLE cloud IN SCHEMA public GRANT SELECT ON TABLES  TO cloud;
